...
While there is a possibility that none of the models will provide an adequate fit, this appears unlikely based on pilot analyses of similar interventions. If none of the models are satisfactory based on the criteria followed in the workflow, we will report all models in the main analysis and interpret the results with appropriate caution, explicitly discussing the limitations. \ 

Additionally, as an exploratory analysis, we will perform prior predictive checks using data simulated with the The Alternating Renewal Process Simulator ([https://jepusto.shinyapps.io/ARPsimulator/](https://jepusto.shinyapps.io/ARPsimulator/)) to assess whether our prior distributions yield plausible outcomes. If needed, we will refine the priors based solely on these simulations. All prior predictive checks and any adjustments to the priors will be conducted prior to fitting the new models to the observed outcome data. 
